...
corrplot(cor_matrix,
         ...
         tl.cex = 1.1,
         tl.col = "black",
         col = colorRampPalette(c("#CCE5FF", "white", "#FFCCCC"))(200),  # Pale blue / pale red
         cl.lim = c(-1, 1),
         insig = "blank",
         diag = FALSE)
...
for (cluster_id in c(1, 2, 3)) {
  ...
  corrplot(cor_matrix, 
           ...
           number.cex = 0.9,           # Size of correlation values
           tl.cex = 1.1,               # Size of axis labels
           tl.col = "red",             # Axis label color
...
corrplot(cor_matrix, 
         method = "color", 
         type = "upper", 
         addCoef.col = "black",   # Coefficient text in black
         tl.col = "black",        # Variable labels in black
         tl.cex = 0.8, 
         number.cex = 0.7,
         col = colorRampPalette(c("blue", "white", "red"))(200),
         cl.lim = c(-1, 1),
         diag = FALSE)            # Remove 1.0 diagonal
